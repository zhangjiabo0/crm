...
class KnowledgeAction extends Action{
	public function _initialize(){
		$action = array(
			'permission'=>array(),
			'allow'=>array('index','getcurrentstatus')
		);
	...
	public function excelExport($knowledgeList=false){
		...
		$objProps->setTitle("crm Konwledge");    
		$objProps->setSubject("crm Konwledge Data");    
		$objProps->setDescription("crm Konwledge Data");    
		$objProps->setKeywords("crm Konwledge");    
        ...
        header("Content-Disposition:attachment;filename=crm_knowledge_".date('Y-m-d',mktime())."_".$current_page.".xls");
