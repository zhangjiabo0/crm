<?php 
	class contractViewModel extends ViewModel {
	   public $viewFields = array(
		'contract'=>array('contract_id','number','price_sheet_id','is_deleted','start_date','end_date','delete_role_id','delete_time','price','due_time','dept_name','creator_role_id','owner_role_id','description','create_time','update_time','status','add_file','_type'=>'LEFT'),
