<?php 
	class PriceSheetViewModel extends ViewModel{
		public $viewFields = array(
			'PriceSheet'=>array('id','number','customer_id','customerB_id','department','role_id','reason','add_file','create_time','total_amount','subtotal_val','willtotal_val','service_val','t_service','t_epiboly','_type'=>'LEFT'),
