<?php 
	class PriceSheetViewModel extends ViewModel{
		public $viewFields = array(
			'PriceSheet'=>array('id','number','customer_id','customerB_id','department','role_id','reason','add_file','approve_status','create_time','is_del','total_amount','subtotal_val','willtotal_val','service_val','t_service','t_epiboly','confirm','confirm_name','update_time','is_again','_type'=>'LEFT'),
