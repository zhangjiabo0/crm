...
<html>
    ...
    <body>
        <div class="wrap">
            <div class="header">
				<h1 class="logo">神洲酷奇软件</h1>
				<span class="anzhuang">|&nbsp;&nbsp;安装向导</span>
				<div class="version">CRM 简体中文 【v0.5.3】 20160127</div>  
			</div>
							...
							<p style="padding:10px;20px;">
								<table>
									...
									<tr>
										...
										<td class="tdright"><input type="text" name="DB_NAME" value="crm"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="tdright"><input type="text" name="DB_PREFIX" value="crm_"></td>
									</tr>
									<tr>
        ...
        <div class="footer"><a>Copyright 2011-2012 浙江神洲酷奇科技发展有限公司  ALL Rights Reserved ICP证书号：浙B2-20130119</a>  </div>
    </body>
	<script>
		$(function(){
			$("#sub").click(function(){
