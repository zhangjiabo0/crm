...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="5"><?php echo L('ALL SEND EMAIL AND SMS AND SMSRECORD');?> <input <?php if(in_array('setting/marketing', $owned_permission)){ echo 'checked="checked"';} ?> class="check_list13" type="checkbox" name="per[]" value="setting/marketing"></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	$("#sub_btn").click(
		function() {
			...
			$.post('<?php echo U("permission/user_authorize");?>',{perlist:perlist_str,position_id:position_id}, function(data){
				alert(data.data);
