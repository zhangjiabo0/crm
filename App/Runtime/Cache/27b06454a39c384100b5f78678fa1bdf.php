...
<div class="container">
	<div class="page-header" style="border:none; font-size:14px;">
		<ul class="nav nav-tabs">
		  ...
		  <li class="active"><a href="<?php echo U('finance/index','t=payables');?>"><img src="__PUBLIC__/img/yingfukuan.png"/> &nbsp; <?php echo L('PAYABLES');?></a></li>
	...
	<p class="view">
		...
		<a href="<?php echo U('finance/index','t=payables');?>" <?php if($_GET['by']== null): ?>class="active"<?php endif; ?>><?php echo L('ALL');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=me');?>" <?php if($_GET['by']== 'me'): ?>class="active"<?php endif; ?>><?php echo L('MY_RESPONSIBLE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=create');?>" <?php if($_GET['by']== 'create'): ?>class="active"<?php endif; ?>><?php echo L('MY_CREATE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=sub');?>" <?php if($_GET['by']== 'sub'): ?>class="active"<?php endif; ?>><?php echo L('SUBORDINATE_RESPONSIBLE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=subcreate');?>" <?php if($_GET['by']== 'subcreate'): ?>class="active"<?php endif; ?>><?php echo L('SUBORDINATE_CREATE');?></a> &nbsp;  &nbsp; 
		<img src=" __PUBLIC__/img/by_status.png"/> 
		<a href="<?php echo U('finance/index','t=payables&by=none');?>" <?php if($_GET['by']== 'none'): ?>class="active"<?php endif; ?>><?php echo L('UNPAID');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=part');?>" <?php if($_GET['by']== 'part'): ?>class="active"<?php endif; ?>><?php echo L('PARTIALLY PAID');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=all');?>" <?php if($_GET['by']== 'all'): ?>class="active"<?php endif; ?>><?php echo L('PAID');?></a> 	 &nbsp;  &nbsp; 
		<img src="__PUBLIC__/img/by_time.png"/> 
		<a href="<?php echo U('finance/index','t=payables&by=today');?>" <?php if($_GET['by']== 'today'): ?>class="active"<?php endif; ?>><?php echo L('TODAY PAYABLE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=week');?>" <?php if($_GET['by']== 'week'): ?>class="active"<?php endif; ?>><?php echo L('THIS WEEK PAYABLE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=month');?>" <?php if($_GET['by']== 'month'): ?>class="active"<?php endif; ?>><?php echo L('THIS MONTH PAYABLE');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=add');?>" <?php if($_GET['by']== 'add'): ?>class="active"<?php endif; ?>><?php echo L('RECENTLY_CREATED');?></a> | 
		<a href="<?php echo U('finance/index','t=payables&by=update');?>" <?php if($_GET['by']== 'update'): ?>class="active"<?php endif; ?>><?php echo L('RECENTLY_MODIFIED');?></a> 	 &nbsp;  &nbsp; 
		<a href="<?php echo U('finance/index','t=payables&by=deleted');?>" <?php if($_GET['by']== 'deleted'): ?>class="active"<?php endif; ?>><img src="__PUBLIC__/img/task_garbage.png"/> <?php echo L('RECYCLE_BIN');?></a> 
	</p>
	...
	<div class="row">
		<div class="span12">
					...
					<ul class="nav pull-left">
						<li class="pull-left">
							<select style="width:auto" name="field" id="field" onchange="changeCondition()">
								...
								<option class="number" value="price"><?php echo L('PAYMENTS');?></option>
			...
			<div class="pull-right">
				<a class="btn btn-primary" href="<?php echo U('finance/add','t=payables');?>"><i class="icon-plus"></i>&nbsp; <?php echo L('ADD PAYABLES');?></a>
			...
			<table class="table table-hover table-striped table_thead_fixed"> 
				<?php if(!empty($list)): ?><thead>
					<tr>
						...
						<th><?php echo L('PAYABLES NAME');?></th>
						<th><?php echo L('CUSTOMER');?></th>
						<th><?php echo L('CONTRACT NUMBER');?></th>
						<?php if(C('ismobile') != 1): ?><th>
								<?php if($_GET['asc_order'] == 'price'): ?><a href="<?php echo U('finance/index','&t='.$_GET['t'].'&desc_order=price&'.$parameter);?>">
										<?php echo L('AMOUNT PAYABLE');?>&nbsp;<img src="__PUBLIC__/img/arrow_up.png">
									</a>
								<?php elseif($_GET['desc_order'] == 'price'): ?>
									<a href="<?php echo U('finance/index','&t='.$_GET['t'].'&asc_order=price&'.$parameter);?>">
										<?php echo L('AMOUNT PAYABLE');?>&nbsp;<img src="__PUBLIC__/img/arrow_down.png">
									</a>
								<?php else: ?>
									<a href="<?php echo U('finance/index','&t='.$_GET['t'].'&desc_order=price&'.$parameter);?>"><?php echo L('AMOUNT PAYABLE');?></a><?php endif; ?>
							</th>
							<th>
								<?php if($_GET['asc_order'] == 'pay_time'): ?><a href="<?php echo U('finance/index','&t='.$_GET['t'].'&desc_order=pay_time&'.$parameter);?>">
										<?php echo L('PAYABLES TIME');?>&nbsp;<img src="__PUBLIC__/img/arrow_up.png">
									</a>
								<?php elseif($_GET['desc_order'] == 'pay_time'): ?>
									<a href="<?php echo U('finance/index','&t='.$_GET['t'].'&asc_order=pay_time&'.$parameter);?>">
										<?php echo L('PAYABLES TIME');?>&nbsp;<img src="__PUBLIC__/img/arrow_down.png">
									</a>
								<?php else: ?>
									<a href="<?php echo U('finance/index','&t='.$_GET['t'].'&desc_order=pay_time&'.$parameter);?>"><?php echo L('PAYABLES TIME');?></a><?php endif; ?>
							</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<?php if(C('ismobile') != 1): ?><td><?php echo L('YUAN',array($vo['price']));?></td>
								...
								<td>
									<?php if($vo['status'] == 2): echo L('PAID'); elseif($vo['status'] == 1): echo L('PARTIALLY PAID'); else: echo L('UNPAID'); endif; ?>
								</td>
								<td><a class="role_info" rel="<?php echo ($vo['owner'][role_id]); ?>" href="javascript:void(0)"><?php echo ($vo['owner'][user_name]); ?></a></td><?php endif; ?>
							...
							<?php elseif(C('ismobile') != 1): ?>
								...
								<td><?php echo (date("Y-m-d",$vo['create_time'])); ?></td><?php endif; ?>
							
							<td>
								<a href="<?php echo U('finance/view','t=payables&id='.$vo['payables_id']);?>"><?php echo L('VIEW');?></a>&nbsp; 
								<?php if($_GET['by']== 'deleted'): ?><a href="<?php echo U('finance/revert','t=payables&id='.$vo['payables_id']);?>"><?php echo L('RESET');?></a>
								<?php else: ?>
									<a href="<?php echo U('finance/edit','t=payables&id='.$vo['payables_id']);?>"><?php echo L('EDIT');?></a><?php endif; ?>
							</td>
...
<?php if(C('ismobile') == 1): ?>width=$('.container').width() * 0.9;<?php else: ?>width=800;<?php endif; ?>
	...
	$(function(){
		...
		$('#delete').click(function(){
			...
			<?php if($_SESSION['admin']== 1 and $_GET['by']== 'deleted'): ?>$("#form1").attr('action', '<?php echo U('finance/completedelete','t=payables');?>');
				$("#form1").submit();
			<?php else: ?>
				$("#form1").attr('action', '<?php echo U('finance/delete','t=payables');?>');
